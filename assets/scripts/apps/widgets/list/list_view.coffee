@Bamboo.module "WidgetsApp.List", (List, App, Backbone, Marionette, $, _, eco) ->
  ...
  class List.Widget extends App.Views.Layout
    ...
    regions:
      ...
      #  "change:colxs"   : "onResize"
      #  "change:colsm"   : "onResize"
      #  "change:colmd"   : "onResize"
      #  "change:collg"   : "onResize"
      #  "change:rowxs"   : "onResize"
      #  "change:rowsm"   : "onResize"
      #  "change:rowmd"   : "onResize"
      #  "change:rowlg"   : "onResize"
      #  "change:state"   : "onResize"
      ...
      #onResize: (e) =>
      #  @$el.attr @attributes()
      #  console.log "width", @$el.width(), @$el.innerWidth(), @$el.outerWidth()
      #  if @$el.width() < 300
  ...
  class List.Widgets extends App.Views.CollectionView
    ...
    onResize: =>
      _.defer =>
        margin = 15
        width = 1000
        cols = if width < 500 then 4 else 6
        widget_base = (width - 2*margin*cols) / cols
        @$el.gridster
          widget_margins: [margin, margin]
          widget_base_dimensions: [widget_base, widget_base]
          max_cols: cols
          resize:
            enabled: true
  ...
  class List.BreadcrumbsToolbar extends App.Views.ItemView
    ...
    events:
      'click button': -> @trigger 'new:widget:clicked', @collection
