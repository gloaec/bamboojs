@Bamboo.module "Entities", (Entities, App, Backbone, Marionette, $, _) ->
  ...
  class Entities.Author extends Entities.Model
    ...
    relations: [
      type: Backbone.Many
      key: 'folders'
      relatedModel: 'Bamboo.Entities.Folder'
    ]
  ...
  class Entities.Folder extends Entities.Model
    ...
    ,
      type: Backbone.Many
      key: 'documents'
      collectionType: 'Bamboo.Entities.DocumentsCollection'
    ,
      type: Backbone.Many
      key: 'children'
      collectionType: 'Bamboo.Entities.FoldersCollection'
    ,
      type: Backbone.Many
      key: 'files'
      collectionType: 'Bamboo.Entities.FilesCollection'
    ]
